...
Откройте в браузере http://serv123.ru. Должно произойти перенаправление на https://serv123.ru (пока будет с ошибкой, так как SSL ещё не настроен).
