...
-p 3000:80	Проброс порта: хост:3000 → контейнер:80
...
Откройте в браузере http://ваш-домен. Должно произойти перенаправление на https://ваш-домен (пока с ошибкой, так как SSL ещё не настроен).
...
Откройте http://ваш-домен:9100/metrics. Должна открыться страница с техническими метриками.
